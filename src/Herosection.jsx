...
function Herosection(){
    return(
        <div className="md:mt-30 flex flex-col  justify-center items-center gap-30 md:flex-row md:items-center md:justify-center z-30" >
                <div className="flex flex-col justify-center items-center gap-5 text-center  mt-24 md:mt-0">
                    <h1 className="text-white text-5xl font-bold px-10 py-10 md:px-3 md:py-10">Uchenna Emeh</h1>
                    <TypeWriter
                        options={{
